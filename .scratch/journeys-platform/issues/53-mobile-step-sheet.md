...
Priority: staging feedback round 4 (Paul, 2026-09-23, triaged the same day): pre-hackathon 46 → 47 → 48 → 49 → 38 → 50 → 51; 52 is grilled in its own thread and may squeeze in; post-hackathon **53** joins sweep 3 (41 → 42 → 44 → 45). Not before 2026-09-25. Also listed on ticket 15.
Route: polish
