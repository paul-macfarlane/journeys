...
Route: polish (no schema, auth provider, or route change; behaviour-preserving)
...
- `src/db/access.ts`, one module:
  ...
  - `getProjectForMember` and `getJourneyForMember` become these, or thin re-exports of them.
