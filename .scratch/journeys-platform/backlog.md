...
| 1 | **1 Saves and unreadable rows** (contract) | [81 One autosave loop](issues/81-one-autosave-loop.md) | polish | ready-for-agent | |
| 2 | 1 | [73 Stale saves are refused](issues/73-stale-saves-refused.md) | contract | ready-for-agent | Blocked by 81 |
| 3 | 1 | [83 Error pages and unreadable Published Versions](issues/83-error-surfaces.md) | contract | ready-for-agent | One "cannot be read" design with 73's corrupt-Draft page |
...
| 5 | 2 | [74 Deploy and test stability](issues/74-deploy-and-test-stability.md) | polish | ready-for-agent | Paul turns on Skew Protection |
