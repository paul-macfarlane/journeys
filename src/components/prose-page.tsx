...
/**
 * The shell every prose-only public page shares — the two legal pages and
 * About: the wordmark as the way home, the title, an optional line under
 * it, the text, and the footer at prose width. Static, so a Participant
 ...
 * a typography plugin: a few pages of headings, paragraphs, and lists do
 * not need one.
 */
