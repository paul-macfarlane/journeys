 ...
 * page sideways.
 *
 * Sticky at every width (ticket 34): the bar stays at the top while the
 * page scrolls beneath it, above everything but open menus and dialogs
 * (`z-40`). A Project or Journey page's tab row sticks directly under it
